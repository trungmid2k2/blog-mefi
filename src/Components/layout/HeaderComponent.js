                ...
                <div className='fixed z-10'>
                    <div className='flex items-center justify-between shadow-lg w-[100vw] bg-white'>
                        <div className='pl-[50px]'>
                            <a href='/'><img className="w-[144px] h-[60px]" src={logoMiddle} alt='logo'></img></a>
                        </div>
                        <div>
                            ...
                            <ul className='flex' >
                                ...
                                <li className='px-4'><NavLink className='hover:text-[#d1bb95] font-medium text-[14px]' to='/'>CATAGORIES</NavLink></li>
